...
<template>
  <div
    class="product-item border border-white/10 bg-[#2a2a2a] sm:hover:-translate-y-[6px]"
  ...
  >
    ...
    <div>
      ...
      <div class="buy-btn pt-2 pb-2 pl-1 pr-1 bg-[#232323] border border-[#353535]" @click.stop="shwoDiscord">
