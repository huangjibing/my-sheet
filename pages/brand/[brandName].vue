...
const brandName = route.params.brandName.toString();
...
const productList = computed(() => {
  return baseStore.getProductBrandSortList(brandName, lastCategory.value != 'All' ? lastCategory.value : firstCategory.value);
});
...
<template>
    <div class="home-ategory">
      ...
      <CategorySelection :brandName="brandName" @onSelect="onSelect" />
    </div>
  <div class="filter">
